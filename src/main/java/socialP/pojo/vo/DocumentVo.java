...
public class DocumentVo {
    ...
    public DocumentVo(Integer documentId, Integer studentId, Integer teamId, Date createTime, Integer documentStatus, String documentType, String documentURL, String content) {
